...
export const LoginForm = ({ navigation }: any) => {
  return (
    <View style={styles.constainer}>
      <AppText style={styles.titlePageText}>Suas Informações</AppText>
      <Pressable
      ...
      <View style={styles.inputContainer}>
        <View style={styles.inputDiv}>
          <AppText style={styles.inputName}>Nome</AppText>
          <TextInput style={styles.input} />
        </View>
        <View style={styles.inputDiv}>
          <AppText style={styles.inputName}>Sobrenome</AppText>
          <TextInput style={styles.input} />
        </View>
        <View style={styles.inputDiv}>
        ...
        <View style={styles.inputDiv}>
          <AppText style={styles.inputName}>Confirmar Senha</AppText>
          <TextInput style={styles.input} />
        </View>
      </View>
